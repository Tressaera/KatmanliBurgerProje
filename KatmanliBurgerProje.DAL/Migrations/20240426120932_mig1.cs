...
namespace KatmanliBurger.Dal.Migrations
{
    public partial class mig1 : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, new DateTime(2024, 4, 26, 15, 9, 32, 441, DateTimeKind.Local).AddTicks(813), "İçecek", 1, null },
                    { 2, new DateTime(2024, 4, 26, 15, 9, 32, 441, DateTimeKind.Local).AddTicks(816), "Patates", 1, null },
                    { 3, new DateTime(2024, 4, 26, 15, 9, 32, 441, DateTimeKind.Local).AddTicks(818), "Tatlı", 1, null },
                    { 4, new DateTime(2024, 4, 26, 15, 9, 32, 441, DateTimeKind.Local).AddTicks(820), "Atıştırmalık", 1, null }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, new DateTime(2024, 4, 26, 15, 9, 32, 441, DateTimeKind.Local).AddTicks(1341), 1, "About", null },
                    { 2, new DateTime(2024, 4, 26, 15, 9, 32, 441, DateTimeKind.Local).AddTicks(1343), 1, "Contact", null },
                    { 3, new DateTime(2024, 4, 26, 15, 9, 32, 441, DateTimeKind.Local).AddTicks(1345), 1, "General", null },
                    { 4, new DateTime(2024, 4, 26, 15, 9, 32, 441, DateTimeKind.Local).AddTicks(1347), 1, "Exception", null },
                    { 5, new DateTime(2024, 4, 26, 15, 9, 32, 441, DateTimeKind.Local).AddTicks(1349), 1, "UIMessagges", null },
                    { 6, new DateTime(2024, 4, 26, 15, 9, 32, 441, DateTimeKind.Local).AddTicks(1351), 1, "AdminMessagges", null }
                });
